...
```
    ...
    ## Warning: Removed 94457 rows containing non-finite values (stat_boxplot).

    ## Warning: Removed 24893 row(s) containing missing values (geom_path).

    ## Warning: Removed 90613 rows containing non-finite values (stat_boxplot).

    ## Warning: Removed 21359 row(s) containing missing values (geom_path).
