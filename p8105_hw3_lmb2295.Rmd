...
tmin_p = 
  ...
  geom_histogram(alpha = .4, adjust = .5, color = "blue") +
labs(
    title = "Min daily Temperature Frequencies",
    x = "Max Temp",
    y = "Frequency") +
  scale_x_continuous(
    breaks = c(-40, -20, 0, 20, 40)) %>% 
